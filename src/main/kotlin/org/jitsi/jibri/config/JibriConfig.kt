...
data class FfmpegExecutorParams(
    ...
    @JsonProperty("video_encode_preset")
    val videoEncodePreset: String = "veryfast",
    @JsonProperty("queue_size")
    val queueSize: Int = 4096,
    @JsonProperty("streaming_max_bitrate")
    val streamingMaxBitrate: Int = 2976,
    @JsonProperty("streaming_buf_size")
    ...
    @JsonProperty("h264_constant_rate_factor")
...
data class JibriConfig(
    ...
    @JsonProperty("ffmpeg_executor_params")
    val ffmpegExecutorParams: FfmpegExecutorParams
)
